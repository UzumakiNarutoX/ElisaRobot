...
def get_user_list(__init__, key):
    with open("{}/ElisaBot/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[ElisaBot] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[ElisaBot]')
...
if ENV:
    ...
    from ElisaBot.config import Development as Config
...
from ElisaBot.modules.helper_funcs.handlers import (
