...
import ElisaBot.modules.sql.notes_sql as sql
from ElisaBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from ElisaBot.__main__ import DATA_IMPORT
from ElisaBot.modules.helper_funcs.chat_status import user_admin
from ElisaBot.modules.helper_funcs.alternate import typing_action

# from ElisaBot.modules.rules import get_rules
import ElisaBot.modules.sql.rules_sql as rulessql

# from ElisaBot.modules.sql import warns_sql as warnssql
import ElisaBot.modules.sql.blacklist_sql as blacklistsql
from ElisaBot.modules.sql import disable_sql as disabledsql

# from ElisaBot.modules.sql import cust_filters_sql as filtersql
# import ElisaBot.modules.sql.welcome_sql as welcsql
import ElisaBot.modules.sql.locks_sql as locksql
...
def export_data(update, context):
    ...
    with open("ElisaBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("ElisaBot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `ElisaBot-Backup` was specially made for notes.".format(
            chat.title,
            chat_id,
            tgl,
        ),
    ...
    os.remove("ElisaBot{}.backup".format(chat_id))  # Cleaning file
